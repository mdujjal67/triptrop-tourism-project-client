            ...
            <div className="navbar bg-base-100 flex flex-col md:flex-row lg:flex-row">
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1">
                        <NavLink className={({ isActive }) => isActive ? 'isActive menu-item mr-4' : 'menu-item mr-3 '} to='/'>Home</NavLink>

                        <NavLink className={({ isActive }) => isActive ? 'isActive menu-item' : 'menu-item'} to='/allTouristsSpot'>All Tourists Spot</NavLink>

                        <NavLink className={({ isActive }) => isActive ? 'isActive menu-item ml-4' : 'menu-item ml-3'} to='/addTouristsSpot'>Add Tourists Spot</NavLink>

                        {/* protected route: After login the menu item will appear */}
                        {
                            user && (<NavLink className={({ isActive }) => isActive ? 'isActive menu-item ml-4' : 'menu-item ml-3'} to='/myList'>My List</NavLink>)
                        }
                    </ul>
                </div>
                ...
                <div className="absolute top-3 right-0 w-10 md:top-5 md:right-56 block lg:hidden">
                    <label className="swap swap-rotate">
                        ...
                        <input className="" type="checkbox" value="synthwave" onChange={handleToggle} />
