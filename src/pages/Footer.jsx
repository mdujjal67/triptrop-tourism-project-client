        ...
        <div className="container mx-auto my-20">
            ...
            <footer className="footer lg:px-10 py-4 border-t bg-base-200 text-base-content border-base-300 ">
                <div className="items-center mx-auto lg:mx-0">
                   <h1 className="text-2xl lg:text-3xl font-bold">Tourism Management</h1>
                    <p>Tourism Management Company <br />Providing reliable tourist services since 1992</p>
                </div>
                <div className="pt-8">
                    <p className="text-gray-500">© Tourism Management 2024</p>
                </div>
